...
//			fclose($fp2) ;
		...
		protected function _generStandard( $regularPath ){
			foreach ( $this->_regularImageStandards as $standard ){
				$this->_generImageFile( $regularPath , $standard[0] , $standard[1] , $standard[2] , $standard[3] , $standard[4]);
			}
		}
		
		protected function _generImageFile( $sFile , $width , $height , $transparent = 0 , $backcolor = null , $focus = null ){
	        $dFile = WeFlex_Image_Processor::switchpic( $sFile , $width , $height , $transparent , $backcolor , $focus );
	        return $dFile;
		}
