<?php 
	class WeFlex_Util
	{
    	 ...
    	 */
    	public static function GenerImageUrlBySize($surl , $width ,$height , $transparent = 0 ){
    		
    		if( $transparent ){
    			$durl = substr($surl,0,strrpos($surl,'.')).'_'.$width . 'x' . $height . ".png";
    		}else{
    			$durl = substr($surl,0,strrpos($surl,'.')).'_'.$width . 'x' . $height . substr($surl,strrpos($surl,'.'));
    		}
		...
		public static function isOddNum( $number ){
